...
<html>
    ...
    <body>
        <section class="container-fluid" id="updateStaff-container">
            ...
            <div class="row">
                ...
                <div class="col">
                    <h2 id="updateStaff">UPDATE STAFF <%= technetStaff.getTechnetid() %></h2>
                </div>         
            </div>
            ...
            <form method="post" action="../TechnetServlet">
                ...
                <div class="row" id="firstName">
                    <div class="col" id="firstnameInput">
                        ...
                        <input type="text" name="firstname" id="firstname" placeholder="Enter you first name" required>
                    </div>
                </div>
                <br/>
                ...
                <div class="row" id="lastName">
                    <div class="col" id="lastnameInput">
                        ...
                        <input type="text" name="lastname" id="lastname" placeholder="Enter you last name" required>
                    </div>
                </div>
                <br/>
                ...
                <div class="row" id="staffPass">
                    <div class="col" id="staffpassInput">
                        ...
                        <input type="password" name="staffpass" id="staffpass" placeholder="Enter password" required>
                    </div>
                </div>
                <br/>
    ...
    <footer class="container-fluid" id="footer" style="background-color:#FFFBE9;">
            <span class="d-block text-center align-middle py-3" style="color:"#rgb(227,202,165);">@AMIT3094 GUI and Web Application Programming (Update Staff)</span>
    </footer>
