...
<html>
        ...
        <section class="container-fluid" id="staff-details-container">
            ...
            <div class="row">
                ...
                <div class="col-2" id="returnButton">
                        ...
                        <a href="../technet_admin/dashboard.jsp"> 
    ...
    <footer class="container-fluid fixed-bottom" id="footer" style="background-color:#FFFBE9;">
            <span class="d-block text-center align-middle py-3" style="color:"#rgb(227,202,165);">@AMIT3094 GUI and Web Application Programming (Admin Profile)</span>
    </footer>
</html>