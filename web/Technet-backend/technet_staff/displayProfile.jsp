...
<html>
        ...
        <section class="container-fluid" id="staff-details-container">
            ...
            <div class="row">
                ...
                <div class="col-2" id="returnButton">
                        ...
                        <a href="../technet_staff/dashboard.jsp"> 
                ...
                <div class="col-8 text-center">
                    <h2 id="staff-details-title">Your Profile</h2>
                </div>       
            </div>
            ...
            <div class="col" id="staff-details">
                <table id="staff-details-table" class="table table-borderless">
                    <tody>
                        <tr>
                            <th scope="col">Your Technet ID :</th>
                ...
                <div class="row text-center" id="buttons">
                        ...
                        <a href="updateProfile.jsp" id="updateButton"><i class="bi bi-pencil-square"></i> Update</a>
    ...
    <footer class="container-fluid fixed-bottom" id="footer" style="background-color:#FFFBE9;">
            <span class="d-block text-center align-middle py-3" style="color:"#rgb(227,202,165);">@AMIT3094 GUI and Web Application Programming (Staff Profile)</span>
    </footer>
</html>