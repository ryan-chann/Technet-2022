    ...
    <body>
                ...
                <div  class="col-1" >
                    ...
                    <form class="row" action ="../Comment" method="POST">
                        ...
                        <!-- Post comment -->
                        <textarea class="form-control" name ="comment" id="staff-comment" rows="3" placeholder="Say Something..."></textarea>
                        <!-- Submit Button -->
