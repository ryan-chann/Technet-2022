...
<html>
        ...
        <section class="container-fluid" id="updateStaff-container">
            ...
            <form method="post" action="../TechnetServlet">
                ...
                <div class="row" id="staffId">
                    <div class="col">
                        <label for="staffID">Your Technet ID :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%= technetStaff.getTechnetid() %></label>
                ...
                <div class="row" id="firstName">
                    <div class="col" id="firstnameInput">
                        ...
                        <input type="text" name="firstname" id="firstname" value="<%= technetStaff.getFirstname() %>" required>
                    </div>
                </div>
                <br/>
                ...
                <div class="row" id="lastName">
                    <div class="col" id="lastnameInput">
                        ...
                        <input type="text" name="lastname" id="lastname" value="<%= technetStaff.getLastname() %>" required>
                    </div>
                </div>
                <br/>
                ...
                <div class="row" id="sSubmitButton" >
                    <div class="col" id="submit" style="padding:10px 0px 0px 100px">
                        <input type="hidden" name="profile" value="staffProfile">
    ...
    <footer class="container-fluid" id="footer" style="background-color:#FFFBE9;">
            <span class="d-block text-center align-middle py-3" style="color:"#rgb(227,202,165);">@AMIT3094 GUI and Web Application Programming (Update Staff Profile)</span>
    </footer>
