<%-- 
    Document   : order
    Created on : Apr 5, 2022, 3:36:05 PM
    Author     : bsgan
--%>
    ...
    <body>
        <section class="container-fluid" id="order-details-container">
            ...
            <div class="row">
                <!-- Back Arrow -->
                <div class="col-1" >
                    <a href="../TechnetServlet?action=dashboard&user=staff"> 
            ...
            <div class="row">
                ...
                <tr>
                    ...
                    <form action="../DisplayOrder_Staff" method="get">
                        <td>
            ...
            <div class="center-order-pagination">
                <div class="order-pagination">
                      ...
                      <a href="../DisplayOrder_Staff?orderCRUD=display">1</a>
                      <a href="../DisplayOrder_Staff?orderCRUD=display&page=2">2</a>
                      <a href="../DisplayOrder_Staff?orderCRUD=display&page=3">3</a>
                      <a href="../DisplayOrder_Staff?orderCRUD=display&page=4">4</a>
                      <a href="../DisplayOrder_Staff?orderCRUD=display&page=5">5</a>
                      <a href="../DisplayOrder_Staff?orderCRUD=display&page=6">6</a>
        ...
        <footer class="container-fluid" id="footer" style="background-color:#FFFBE9;">
                <span class="d-block text-center align-middle py-3" style="color:"#rgb(227,202,165);">@AMIT3094 GUI and Web Application Programming (Display Order for Staff)</span>
        </footer>
